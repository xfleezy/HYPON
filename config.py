...
config_args = {
    ...
    'model_config': {
        ...
        'model': ('HYPON', 'which encoder to use, can be any of [HyperGCN]'),
        ...
        'use-message':(0,'whether to pass message on split nodes or not'),
        'use-mean':(0,'which permutation invariant layer to use') 
    },
    'data_config': {
        'dataset': ('cora', 'which dataset to use'),
        'avg': ('0','whether to use average feature as the input of HGCN etc.'),
